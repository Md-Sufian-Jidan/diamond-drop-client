...
const WhyChooseUs = () => {
    return (
        <section className="py-20 px-4 text-white bg-transparent">
            <div className="max-w-6xl mx-auto text-center">
                <h2 className="text-4xl font-bold text-gold mb-4">Why Choose DiamondDrop?</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {features.map((feature, index) => (
                        <motion.div
                            ...
                            className="bg-white/10 backdrop-blur-lg border border-white/20 p-6 rounded-2xl shadow-xl hover:scale-105 transition-transform duration-300"
                        >
